       ...
       <p id="error">${errorMsg}</p>
         <table id="main">
            ...
            <tr>
              <th>性別</th>
              <td >
              <form:radiobutton path="gender" value="0" checked="${emp.gender == '0' ? 'checked' : '' }" />男
              <form:radiobutton path="gender" value="1" checked="${emp.gender == '1' ? 'checked' : '' }"  />女
              </td>
            </tr>
            <tr>
              <th>名前</th>
            ...
            <tr>
              <th>E-Mail</th>
              <td class="cp_iptxt">
              <form:input type="email" size="16" maxlength='25' path="address" />
              </td>
            </tr>
            <tr>
              <th>年齢  </th>
              <td>
               <form:select  type="age" path="age" id="age" >
               </form:select>歳
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <th>管理者権限</th>
              <td>
              <form:radiobutton path="admin_auth" value="0" checked="${emp.admin_auth == '0' ? 'checked' : '' }" />無
              <form:radiobutton path="admin_auth" value="1" checked="${emp.admin_auth == '1' ? 'checked' : '' }"  />有
              </td>
            </tr>
            <tr>
              <th>パスワード</th>
          ...
          <input type="submit" class="btn-square-so-pop" value="編集">
